                                ...
                                <div class="sort-by-cover mr-10">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a  class="{{ $pageSize==3 ? 'active': ''}}" href="#" wire:click.prevent="changePageSize(3)">3</a></li>
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{route('product.details',['slug'=>$product->slug])}}">
                                                <img class="default-img" src="{{asset('assets/imgs/shop/chauss')}}{{$product->id}}.png" alt="{{$product->name}}">
                                                <img class="hover-img" src="{{asset('assets/imgs/shop/chauss')}}{{$product->id}}-1.png" alt="{{$product->name}}">
                                            </a>
                                        </div>
